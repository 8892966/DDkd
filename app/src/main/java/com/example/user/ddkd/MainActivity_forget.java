...
public class MainActivity_forget extends BaseActivity implements View.OnClickListener,IForgetView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iForgetPresenter=new ForgetPresenterImpl(this);
//        iForgetPresenter=new ForgetPresenterImpl();
        ...
        et_phone_number.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (et_phone_number.length() == 11) {
                    iForgetPresenter.phoExist(et_phone_number.getText().toString().trim());
            ...
            case R.id.commitpassword:
                if(!TextUtils.isEmpty(et_yanzhengma.getText().toString())) {
                    ...
                    if (PasswordUtil.isSame(this, password1, password2)) {
                        iForgetPresenter.UpdatePsw(et_phone_number.getText().toString(), et_new_password.getText().toString(), et_yanzhengma.getText().toString());
//                        showProgressDialog();
//                        volley_XGMM_GET(et_phone_number.getText().toString(), et_new_password.getText().toString(), et_yanzhengma.getText().toString());
            ...
            case R.id.tv_button_yanzhengma:
                iForgetPresenter.modifyPsw(et_phone_number.getText().toString());
...
//                countDown();
    ...
    @Override
    public void yanzhengmabuttonEnabled(boolean b) {
        tv_button_yanzhengma.setEnabled(b);
    }

    @Override
    public void yanzhengmabuttonText(String s) {
